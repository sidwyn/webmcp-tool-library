...
globalThis.window = { location: { href: 'https://www.walmart.com/search?q=headphones' } };
globalThis.document = {
  querySelector: () => null,
  querySelectorAll: () => [],
  dispatchEvent: () => {},
...
const toolDir = join(__dirname, '../content/sites/walmart/tools');
...
describe('Walmart tool schemas', () => {
  const toolEntries = Object.entries(tools);

  it('loaded at least 7 tools', () => {
    expect(toolEntries.length).toBeGreaterThanOrEqual(7);
  });
